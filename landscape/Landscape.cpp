...
void Landscape::setup() {
	...
	//  lightingShader = createDefaultShader(SHADER_CODE(landscape_ScreenQuadVert),
	//  SHADER_CODE(landscape_LightingFrag)); lightingShader->attachShaderLib(SHADER_CODE(landscape_ScatterLib));
	//  ssaoShader = createDefaultShader(SHADER_CODE(landscape_ScreenQuadVert), SHADER_CODE(landscape_SSAOFrag));
	//  ssaoBlurShader = createDefaultShader(SHADER_CODE(landscape_ScreenQuadVert),
	//  SHADER_CODE(landscape_SSAOBlurFrag));
